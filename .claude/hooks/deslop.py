...
CHECKS = [
    ...
    ("W2", "not-X-but-Y framing", re.compile(
        ...
        r"|\bless about\b[^.!?]{0,60}\bmore about\b)", re.I)),
    ...
    # The contrast sentence in both directions: "it's a bug, not a nitpick"
    # and "it's not a bug, it's a design choice". The writer states the
    # thing, then bolts on the rejected alternative. State the thing and stop.
